...
import { getAllBlogs, deleteBlog, clearError } from '../store/slices/adminSlice';
...
const AdminBlogs = () => {
  ...
  useEffect(() => {
    dispatch(getAllBlogs({ page: currentPage, limit: 10 }));
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">View and manage all blogs on the platform</p>
        </div>
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900">All Blogs ({blogs.pagination?.totalBlogs || 0})</h2>
          </div>
            ...
            <div className="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
              <div className="flex-1 flex justify-between sm:hidden">
                <button
                  ...
                  disabled={!blogs.pagination.hasPrev}
                ...
                <button
                  onClick={() => handlePageChange(currentPage + 1)}
                  disabled={!blogs.pagination.hasNext}
                ...
                <div>
                  <p className="text-sm text-gray-700">
                    ...
                    <span className="font-medium">
                      {Math.min(currentPage * 10, blogs.pagination.totalBlogs)}
                    </span>
                    {' '}of{' '}
          ...
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
              <div className="mt-3 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mt-4">Delete Blog</h3>
