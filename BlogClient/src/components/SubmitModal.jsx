...
const SubmitModal = ({ isOpen, onClose }) => {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        const base64DataUrl = reader.result; // e.g., data:image/png;base64,....
        setFormData(prev => ({
          ...prev,
          image: base64DataUrl,
              ...
              <div className="border-t border-gray-600 pt-6">
                ...
                <div className="bg-gray-700 rounded-xl p-4">
                  <div className="space-y-3">
                    ...
                    <div>
                      <h5 className="font-semibold text-white">{formData.title}</h5>
                      {formData.category && (
                        <span className="inline-block mt-1 px-2 py-1 text-xs font-medium bg-primary-900 text-primary-200 rounded-full border border-primary-700">
                          {formData.category}
                        </span>
                      )}
